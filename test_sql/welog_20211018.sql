...
-- 테이블 데이터 welog.article:~36 rows (대략적) 내보내기
...
INSERT INTO `article` (`id`, `user_id`, `subject`, `content`, `image_src`, `likehit`, `created_date`, `updated_date`) VALUES
	...
	(91, 10, '로그 남기기2', '남겨 남겨요 왔다 감', NULL, 3, '2021-10-11 10:52:00', '2021-10-15 16:15:00'),
...
-- 테이블 데이터 welog.comment:~0 rows (대략적) 내보내기
/*!40000 ALTER TABLE `comment` DISABLE KEYS */;
INSERT INTO `comment` (`id`, `article_id`, `user_id`, `content`, `created_date`, `username`) VALUES
	(1, 91, 25, '댓글 테스트', '2021-10-18 11:24:53', NULL),
	(2, 91, 10, '관리자예요', '2021-10-18 11:25:24', NULL),
	(3, 92, 10, '관리자 댓글', '2021-10-18 13:47:52', NULL);
...
-- 테이블 데이터 welog.like_article_user:~12 rows (대략적) 내보내기
